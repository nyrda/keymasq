...
package() {
    ...
    local icon
    local size
    for icon in assets/icons/keyforge-*.png; do
        size="${icon##*-}"
        size="${size%.png}"
        install -Dm644 "$icon" \
            "$pkgdir/usr/share/icons/hicolor/${size}x${size}/apps/keyforge.png"
    done
