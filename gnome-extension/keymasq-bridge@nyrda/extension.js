    ...
    _connect() {
        ...
        this._client.connect_async(address, null, (_client, res) => {
            try {
                ...
                this._sendMessage({type: 'hello', protocol: KeymasqBridge.PROTOCOL_VERSION})
                this._sendFocusChanged()
                this._readLoop()
            } catch (_e) {
...
export default class KeymasqBridgeExtension extends Extension {
    enable() {
        this._bridge = new KeymasqBridge()
        this._bridge.enable()
    }
