...
from keyforge.cli.commands import (
    cancel_macro_cli,
    create_hardware,
    list_devices,
    list_macros_cli,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="keyforge",
        description="Keyforge CLI - Key remapping tool",
    )
    ...
    diagnostics_parser = subparsers.add_parser("diagnostics", help="Toggle keyforged diagnostics")
