...
class Application(Adw.Application):
    def __init__(self, demo_mode: bool = False) -> None:
        super().__init__(
            application_id="dev.keyforge.Keyforge",
    ...
    def do_startup(self) -> None:
        ...
        with resources.as_file(resources.files("keyforge").joinpath("gui/style.css")) as css_path:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="keyforge",
        description="Keyforge - Key remapping tool GUI",
    )
    parser.add_argument(
        "--demo",
        action="store_true",
