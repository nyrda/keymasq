...
log = logging.getLogger("keyforge-session.listeners.niri")
...
NIRI_DISPATCH_BUILDERS: dict[str, NiriDispatchBuilder] = {
    "close_window": _focused_window_optional_id_action("CloseWindow"),
    "fullscreen_toggle": _focused_window_optional_id_action("FullscreenWindow"),
    "windowed_fullscreen_toggle": _focused_window_optional_id_action(
    ...
    "focus_window_down": _no_arg_action("FocusWindowDown"),
    "move_column_left": _no_arg_action("MoveColumnLeft"),
    "move_column_right": _no_arg_action("MoveColumnRight"),
    "move_window_up": _no_arg_action("MoveWindowUp"),
    "move_window_down": _no_arg_action("MoveWindowDown"),
    "focus_workspace_up": _no_arg_action("FocusWorkspaceUp"),
    "focus_workspace_down": _no_arg_action("FocusWorkspaceDown"),
    "focus_workspace_previous": _no_arg_action("FocusWorkspacePrevious"),
    "focus_workspace": _focus_workspace_action,
    "move_window_to_workspace": _move_window_to_workspace_action(True),
    "send_window_to_workspace": _move_window_to_workspace_action(False),
}
...
class NiriListener(WindowListener):
    ...
    async def dispatch(self, dispatcher: str, args: str = "") -> tuple[bool, str]:
        ...
        if builder is None:
            return False, f"unsupported Niri dispatcher: {dispatcher_name}"

        ok, message, action = builder(str(args or "").strip())
