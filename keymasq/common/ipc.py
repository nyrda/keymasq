...
class CommandType(Enum):
    ...
    TRACK_PROFILE_ACTIVATION = "track_profile_activation"
    CANCEL_PROFILE_ACTIVATION = "cancel_profile_activation"
    PROFILE_DEACTIVATE_REQUESTED = "profile_deactivate_requested"
