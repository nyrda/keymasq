...
pad's half-width inside the last 4-16 ms before the zero release, and a landing
drifts for about 20 ms. Pad pressure does not help: light touches never report any.
"""
...
class TouchpadContact:
    ...
    finger has already earned zero latency. Motion during the first SETTLE_S of
