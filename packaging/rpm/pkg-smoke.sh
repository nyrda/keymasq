...
assert_file /usr/share/applications/io.github.nyrda.Keymasq.desktop
assert_file /usr/share/metainfo/io.github.nyrda.Keymasq.metainfo.xml
assert_file /usr/share/icons/hicolor/scalable/apps/io.github.nyrda.Keymasq.svg
for size in 16 22 24 32 48 64 128 256 512; do
    assert_file "/usr/share/icons/hicolor/${size}x${size}/apps/io.github.nyrda.Keymasq.png"
done
...
assert_cmd "desktop icon name matches app identity" python3 -c "from configparser import ConfigParser; from keymasq.gui.application import APP_ICON_NAME, APP_ID; parser = ConfigParser(interpolation=None); parser.read('/usr/share/applications/io.github.nyrda.Keymasq.desktop', encoding='utf-8'); entry = parser['Desktop Entry']; assert entry['Icon'] == APP_ICON_NAME == APP_ID"
