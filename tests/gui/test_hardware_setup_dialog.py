...
class TestHardwareSetupDialog:
    ...
    def test_build_evdev_devices_preserves_real_path_separate_from_config_path(self):
        ...
        assert devices[0].path == "/dev/input/event20"
    ...
    def test_selecting_in_use_raw_row_disables_next(self, monkeypatch):
        ...
        dialog = HardwareSetupDialog(Gtk.Window(), SimpleNamespace())
        dialog._show_raw_evdev_devices = True
        dialog._start_discover_interfaces = lambda: None  # type: ignore[method-assign]
    ...
    def test_model_path_gamepad_selected_config_id_allocates_lowest_free_id(
        self, monkeypatch
    ):
        gi.require_version("Gtk", "4.0")
        from gi.repository import Gtk
        ...
        dialog = HardwareSetupDialog(
            Gtk.Window(),
            SimpleNamespace(
                list_hardware_ids=lambda: ["045e:02a1", "045e:02a1@3", "045e:02a1@5"]
            ),
        )
