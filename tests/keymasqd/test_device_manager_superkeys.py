...
class TestSuperkeys:
    ...
    @pytest.mark.asyncio
    async def test_tap_superkey_profile_lifetime_filters_trigger_end_for_pulse(
        self,
        monkeypatch: pytest.MonkeyPatch,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_overload_down_superkey_profile_lifetime_filters_trigger_end_for_pulse(
        self,
        monkeypatch: pytest.MonkeyPatch,
    ) -> None:
        monkeypatch.setattr(gdm, "resolve_stable_path", lambda path: path)
