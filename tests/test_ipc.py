...
class TestCommandTypes:
    ...
    def test_command_type_values(self):
        ...
        assert CommandType.SET_CURSOR_POSITION.value == "set_cursor_position"
        assert CommandType.SET_CURSOR_POSITION_BACKEND.value == "set_cursor_position_backend"
        assert CommandType.SET_CURSOR_POSITION_RESULT.value == "set_cursor_position_result"
